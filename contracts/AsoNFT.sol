...
contract AsoNFT is ERC721URIStorage {
    ...
    mapping(uint => bool) public isListed; // Tracks whether a design is listed for sale
    uint public nextTokenId;
    address public owner;

    event DesignCreated(
        uint indexed designId,
    ...
    function getDesign(uint designId) external view returns (
        string memory ipfsHash,
        address designer,
        uint pricePerYard,
        uint totalYards,
